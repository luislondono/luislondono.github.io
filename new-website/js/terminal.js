...
function generateTerminal() {
 ...
 const terminalText = generateNode("div", terminalBody, "terminal-text", "luislondono.com ~: user$\nhello")
 ...
 terminalBody.addEventListener("click", (e) => { handleActiveTerminal(true, terminalContainer) })
 close.addEventListener("click", (e) => { closeTerminal(terminalContainer) })
}
